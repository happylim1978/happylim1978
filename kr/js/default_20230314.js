		...
		'<div class="gnb-in">' +
			...
			'<ul class="area-l">' +
				'<li class="sub-item1">' +
					...
					'<a href="https://www.multicampus.com/kr/service/consulting.html" class="m-sub-link-current"><span>서비스</span></a>' +
					'<!-- gnb-sub -->' +
					'<div class="gnb-sub">' +
				...
				'<li class="sub-item2">' +
					...
					'<a href="https://www.multicampus.com/kr/contents/dt.html"><span>콘텐츠</span></a>' +
					'<!-- gnb-sub -->' +
					'<div class="gnb-sub">' +
						'<div class="gnb-sub-in">' +
							'<div class="gnb-msg">' +
						...
						'<div class="gnb-sub-in">' +
							...
							'<div class="sub-item">' +
								'<ul>' +
									...
									'<li><a href="/kr/solution/serilibrary/">지식 라이브러리</a></li>' +
								'</ul>' +
							'</div>' +
						'</div>' +
					'</div>' +
		...
		'<div class="gnb-sub-service gnb-sub-service2-a">' +
			'<div class="gnb-sub-service-in">' +
				...
				'<span class="mw">'+
					...
					'<a class="subitemlink" href="/kr/solution/serilibrary/">지식 라이브러리</a>' +
				'</span>' +
			'</div>' +
		'</div>' +
	...
	var _footer = 
			'<div class="b2b">' +
				'<div class="fo_comp_wrap">' +
					'<ul>' +
						'<li><img src="http://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-01.png?ver=20220922" alt="고용노동부 | 직업능력심사평가원 원격평생교육원 우수훈련기관 5년 인증기간: 2022.01~2026.12"> </li>' +
						'<li><img src="http://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-02.png?ver=20220922" alt="고용노동부 인적자원개발 우수기관 3년 인증기간: 2020.09~2023.09"> </li>' +
						'<li><img src="http://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-07.png?ver=20220922" alt="여성가족부 가족친화 우수기업 3년 인증기간: 2022.12~2024.11"> </li>' +
						'<li><img src="http://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-09.png?ver=20220922" alt="ISMS 인증범위 Total HRD 서비스 운영 2018.11.06~2021.11.05"> </li>' +
					'</ul>' +
				'</div>' +
							...
							'<div class="agree-select">' +
								'<div class="combobox-wrap" data-js="combobox">' +
									'<select id="agree-p-select2" title="이용약관" class="combobox combobox--basic initial">' +
										'<option value="agree">2022년 8월 18일 시행일자 기준</option>' +
