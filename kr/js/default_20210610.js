$(document).ready(function() {
	...
	*/
	...
	$mGnbs.find('[class^="sub-item"] > a').on('click', function () {
		...
		/*
		if( !$(this).closest('li').hasClass('sub-item3') ) {
			//return false
		}
		*/
	});
					...
					'<div class="etc_link_wrap">' +
						'<div id="crazy">' +
							'<ul class="etc_link">' +
								...
								'<li class="wrong"><a href="/om/about/sub/wrongReportPopup">부정제보</a></li>' +
			...
			'<div class="c-modal__wrap" role="document">' +
				...
				'<div class="c-modal__body">' +
					'<div class="c-modal__scroll">' +
						...
						//				'<option value="agree">2021년 5월 27일 시행일자 기준</option>' +
						//				'<option value="agree_20210507">2021년 5월 7일 시행일자 기준</option>' +
						//			'</select>' +
						//		'</div>' +
						//	'</div>' +
