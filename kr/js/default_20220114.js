						...
						'<div class="gnb-sub-in">' +
							...
							'<div class="add-items">' +
								'<div class="add-item">' +
									...
									'<div class="button-detail">' +
										'<a target="_blank" href="https://www.multicampus.com/system/menu/iframe?p_url=aHR0cHM6Ly9lbC5tdWx0aWNhbXB1cy5jb20vZGVfY29tbW9uL2IyYy9tYWlsLzIwMjAvMDMvMDMyNF8xLzAzMjRfMS5odG1s&htmlHghtPixelSize=4000&p_menu=MjY5I01BSU4=&p_gubun=Qw==" class="link-detail">자세히 보기</a>' +
									'</div>' +
								'</div>' +
								'<div class="add-item">' +
	...
	var _footer = 
			'<div class="b2b">' +
				'<div class="fo_comp_wrap">' +
					'<ul>' +
						'<li><img src="https://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-01.png" alt="고용노동부 | 직업능력심사평가원 직업능력개발 우수 훈련기관 3년 2019.10 ~ 2022.9"> </li>' +
						'<li><img src="https://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-02.png" alt="인적자원개발 우수기관"> </li>' +
						'<li><img src="https://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-03.png" alt="개인정보보호 우수사이트"> </li>' +
						'<li><img src="https://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-04.png" alt="정보통신산업진흥청 NIPA(정보통신산업진흥원) 이러닝 품질인증"> </li>' +
						'<li><img src="https://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-07.png" alt="가족친화 우수기입"> </li>' +
						'<li><img src="https://el.multicampus.com/de_common/b2c/info/images/common/banner-dark-09.png" alt="ISMS 인증범위 Total HRD 서비스 운영 2018.11.06~2021.11.05"> </li>' +
					'</ul>' +
				'</div>' +
					...
					'<div class="etc_link_wrap">' +
						'<div id="crazy">' +
							'<ul class="etc_link">' +
								...
								'<li class="recruit"><a href="https://multicampus.recruiter.co.kr" target="_blank">채용안내</a></li>' +
								...
								'<li class="none"></li>' +
								'<li class="open"><a href="https://www.multicampus.com/main/content/sub/OSLNotice" target="_blank">오픈소스라이선스</a></li>' +
