        ...
        ListEventRenderer.prototype.renderSegHtml = function (seg) {
            ...
            return '<tr class="' + classes.join(' ') + '">' +
                (this.displayEventTime ?
                    '' :
                    '') +
                '<td class="fc-list-item-title ' + theme.getClass('widgetContent') + '" ' + (bgColor ? 'style="background-color:' + bgColor +' " ':' ' ) + '>' +
                '<a' + (url ? ' href="' + core.htmlEscape(url) + '"' : '') + '>' +'<span class="fc-title">'+
                core.htmlEscape(eventDef.title || '')+'</span><br><span class="time">'+timeHtml+'</span>' +
                '</a>' +
                '</td>' +
                '</tr>';
        };
