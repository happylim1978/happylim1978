    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                legend: {
                    ...
                    labelBoxBorderColor: '#777', // border color for the little label boxes
                ...
                grid: {
                    ...
                    tickColor: "#EFF2F7", // color for the ticks, e.g. "rgba(0,0,0,0.15)"
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < entries.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style="border:1px solid ' + options.legend.labelBoxBorderColor + ';padding:1px"><div style="width:6px; height:0; border:5px solid ' + entry.color + ';"></div></div></td>' +
